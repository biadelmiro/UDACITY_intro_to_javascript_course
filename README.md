...
To access the console you first need to open the developer tools, which can be done by right clicking the page and selecting inspect. Once open, you can find the JavaScript Console by clicking on the Console tab.
