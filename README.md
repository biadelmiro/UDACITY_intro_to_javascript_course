...
With loops you often need to increase or decrease the value of a variable in order to step through the loop. For instance, with this loop we’re using x = x + 1 to increase the value of x by 1 before it starts the next iteration of the loop.
