...
You can access the console by either using the instructions or shortcuts previously mentioned in the Developer Tools. Alternatively, if using Chrome, you can use the shortcut Cmd+Option+J (Mac) or Ctrl+Shift+J (Windows).
